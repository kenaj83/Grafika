...
const upperBaseGeometry1 = new THREE.CylinderGeometry(0.5, 0.5, 0.25, 100);
const upperBase1 = new THREE.Mesh(upperBaseGeometry1, material);
upperBase1.position.y = 2.8;

const upperBaseGeometry2 = new THREE.CylinderGeometry(0.7, 0.7, 0.5, 200);
const upperBase2 = new THREE.Mesh(upperBaseGeometry2, material);
upperBase2.position.y = 3.0;

let group = new THREE.Group();
group.add(base);
group.add(upperBase);
group.add(upperBase1);
group.add(upperBase2);
