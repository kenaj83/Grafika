		...
		public class Lab5 extends GLJPanel implements GLEventListener, KeyListener
		{
		    ...
		    public void Spirala(GL2 gl2,int radius, int numberOfTurns){
		        ...
		        for (int i = 1; i <= 1000; i++) {
		            ...
		            gl2.glColor3f(0,255,255);                       //cyan                            
		            x = (float) (3 * Math.cos(angle));
		            z = (float) (3 * Math.sin(angle));
...
// ##################################################################################################################################3
		    public void Triangle(GL2 gl2){
		        ...
		        gl2.glColor3f(0,255,255);//( 0.0f, -1.3f, 0.0f );  // Cyan
		        gl2.glVertex3f( 0.0f, 5.0f, -4.85f );
		        gl2.glColor3f(0,255,255);//( 1.0f, 0.65f, 0.80f );  // Cyan
		        gl2.glVertex3f( 1.45f, -2.0f, 0.0f );
